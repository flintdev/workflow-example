...
import (
	...
	"workflow-example/workflows/workflow1/steps/step1"
	"workflow-example/workflows/workflow1/steps/step2"
	"workflow-example/workflows/workflow1/steps/step3"
	"workflow-example/workflows/workflow1/steps/step4"
)
